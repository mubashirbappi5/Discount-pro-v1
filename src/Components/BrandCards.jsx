...
const BrandCards = ({data}) => {
  ...
  <input type="radio" name="rating-2" className="mask mask-star-2 bg-orange-400" />
    ...
    {
        isSaleOn && <h1 className='flex items-center gap-2'><img src="https://img.icons8.com/?size=100&id=97WBBzi56mor&format=png&color=000000" alt="" className='w-10' /> <span className='text-lg font-semibold text-pink-600'>sale is on</span></h1>
    }
    </div>
